    ...
    <div className="animate-in">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 mb-3">
          ...
          <span style={{ fontFamily: "var(--font-sans)" }} className="text-xl font-semibold text-gray-900">DebtTrack</span>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60 mb-5"
        >
          {googleLoading ? (
            <span className="w-4 h-4 border-2 border-gray-400 border-t-transparent rounded-full spinner" />
          ) : (
