...
export async function sendDueDateReminder({
  to, name, counterparty, dueDate, amount, type, transactionId,
}: {
  to: string; name: string; counterparty: string;
  dueDate: Date; amount: number; type: string; transactionId: string;
}) {
