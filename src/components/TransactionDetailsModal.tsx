        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl w-full max-w-md animate-in">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={onClose}
                className="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors ml-1"
              >
          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-gray-50 rounded-xl p-3">
                ...
                <p className="text-xs text-gray-400">
                  {Number(tx.interestRate)}{tx.interestType === "PERCENT" ? "%" : "₱"} {tx.interestType === "PERCENT" ? "" : "flat"}
                </p>
              </div>
